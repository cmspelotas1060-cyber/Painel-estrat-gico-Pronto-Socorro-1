...
const AdminPanel: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (savedDetailedStats) {
       ...
       // Merge with default to ensure new keys (q1, q2...) exist if they were added later
  ...
  const updateStat = (itemId: string, key: keyof typeof SINGLE_MONTH_STATS, value: string) => {
    const period = itemPeriods[itemId]; // Get the period currently selected for this item
